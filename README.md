# <img src="icon.png" alt="Image description" style="width:40px;height:30px;"> TimeSRA: Aligning Streaming Time Series with LLMs for Rapid Impact Analysis
<!--
